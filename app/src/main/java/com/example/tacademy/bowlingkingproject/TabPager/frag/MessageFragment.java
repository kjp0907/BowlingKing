...
import com.example.tacademy.bowlingkingproject.TabPager.Message.MessageOneFragment;
import com.example.tacademy.bowlingkingproject.TabPager.Message.MessageTwoFragment;
...
public class MessageFragment extends Fragment {
    ...
    public void changeOne(){
        fragment = new MessageOneFragment();
        FragmentTransaction transaction =getFragmentManager().beginTransaction();
        transaction.replace(R.id.hi, fragment);
        transaction.commit();
    }
    public void changeTwo(){
        fragment = new MessageTwoFragment();
        FragmentTransaction transaction =getFragmentManager().beginTransaction();
        transaction.replace(R.id.hi, fragment);
        transaction.commit();
    }
