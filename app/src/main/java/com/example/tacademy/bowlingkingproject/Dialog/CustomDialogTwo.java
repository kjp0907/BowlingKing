...
public class CustomDialogTwo extends Dialog {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.alert_two_layout);
    ...
    public CustomDialogTwo(Context context, String title, View.OnClickListener leftListener,
